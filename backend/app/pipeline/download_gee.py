...
The same EOG VNL V2.2 product is hosted in GEE's public catalog
with public domain licensing (Colorado School of Mines), bypassing
the license wall on eogdata.mines.edu.
...
Usage:
    python -m app.pipeline.download_gee --year 2023
    python -m app.pipeline.download_gee --year 2023 --bbox -170,5,-40,75
    python -m app.pipeline.download_gee --year 2023 --global
"""
